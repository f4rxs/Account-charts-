...
int main() {
    ForestTree tree;
    ForestTree* treePtr = new ForestTree();
    // Root account
    ...
    // dynamic tree testing for the destructor
    treePtr->insert(acc1); // Root
    treePtr->insert(acc4); // Yet another child of 1
    treePtr->insert(acc2); // Child of 1
    treePtr->insert(acc3); // Another child of 1

    treePtr->insert(acc5); // Child of 11
    treePtr->insert(acc6); // Another child of 11
    treePtr->insert(acc7); // Child of 12
    treePtr->insert(acc8); // Child of 111
    treePtr->insert(acc9); // Child of 121

    treePtr->insert(acc10); // Account with id 2
    treePtr->insert(acc11); // Account with id 9
    treePtr->insert(acc12); // Child of 9

    // Print the tree structure
    cout << "Tree Structure:" << endl;
    treePtr->printTree();

    cout << endl << "Deleting the tree..." << endl;
    delete treePtr;
